...
const stats = [
  { label: "Smarter decisions made", value: "25k+" },
  { label: "Websites supported", value: "Any" },
...
const steps = [
  {
    ...
    description:
      "Open any product page on any website. Rasphia understands the context instantly.",
    icon: Search,
  },
  {
    title: "Ask & compare",
    description:
      "Decode reviews, compare alternatives, and uncover trade-offs in plain language.",
    icon: Sparkles,
  },
  {
    title: "Decide confidently",
    description:
      "Buy, save, or explore better options — with clarity and confidence.",
    icon: HeartHandshake,
  },
];
...
const testimonials = [
  {
    quote:
      "Felt like having an expert quietly guiding me while shopping online.",
    author: "Medha A.",
  },
  {
    quote: "I finally understand reviews instead of scrolling endlessly.",
    author: "Kabir L.",
  },
  {
    quote: "It saved me from buying the wrong thing more than once.",
    author: "Sahana V.",
  },
];
          ...
          <header className="mt-16 grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              <p className="inline-flex items-center gap-2 rounded-full bg-white/70 px-4 py-1 text-sm font-medium text-stone-600">
                <Sparkles className="h-4 w-4" /> Works on any website
              </p>

              <h1 className="mt-6 font-serif text-5xl leading-tight md:text-6xl">
                Shop smarter on{" "}
                <span className="text-amber-700">any website</span>.
              </h1>

              <p className="mt-5 text-lg text-stone-600">
                Rasphia is an AI-powered Shopping Assistant that understands the
                page you’re on — helping you compare products, decode reviews,
                and make confident buying decisions anywhere you shop.
              </p>

              {/* 🔁 PRIMARY CTA REPLACED (A) */}
              <div className="mt-8 flex flex-col gap-4 sm:flex-row">
                <a
                  href="https://chromewebstore.google.com/detail/lhcccmjjmabkbaiidfeljkmheodijgmc"
                  target="_blank"
                ...
                <div className="mt-4 space-y-4 text-sm">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="rounded-2xl rounded-tl-sm bg-gradient-to-r from-white via-stone-50 to-amber-50 px-4 py-3 text-stone-800 shadow-md">
                      Here’s a quick breakdown — pros, cons, and better
                      alternatives.
                    </div>
                  </div>
                </div>
